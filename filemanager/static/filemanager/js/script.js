...
function show_files(id) {
    ...
    files = get_dir(id).files.sort(function(a, b) {
...
function do_action(act, t) {
    ...
    if(t == 'dir') {
        if(act == 'add')
            heading = "Enter name of sub-folder";
        if(act == 'rename')
            heading = "Enter new name of folder";
        if(act == 'delete') {
            form_submit(act, t);
            return;
        }
    ...
    if(t == 'file') {
        if(act == 'rename')
            heading = "Enter new name of file";
        if(act == 'delete') {
            form_submit(act,t);
            return;
        }
...
function form_submit(action,type,value){
    ...
    if(action == 'upload') {
        ...
        if(type == 'dir')
            $('#path').val(get_path(selected_dir_id));
        if(type == 'file')
            $('#path').val(get_path(dir_id)+selected_file);
        $('#action').val('rename');
        $('#name').val(value);
        $('#submit').trigger('click');
    }
